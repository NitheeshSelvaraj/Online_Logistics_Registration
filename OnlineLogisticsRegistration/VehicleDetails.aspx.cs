    ...
    public partial class VehicleDetails : System.Web.UI.Page
    {
        ...
        protected void vehicleDetailsGrid_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Write("vehicle id or vehicle number is repeated");
                }
            }
            catch (Exception)
            {
                Response.Write("Null values not allowed-Every values should be filled");
            }
        }
        ...
        protected void vehicleDetailsGrid_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                Response.Write("Details Not Deleted");
            }
        ...
        protected void addbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("Null Values are not Allowed-Enter all the value");
            }
        }
    }
}